...
Visually determining trends between the predictors and the response with a response is that ordinal requires tossing aside scatter plots for a better suited tools. Violinplots will be used to gauge the  [https://chartio.com/learn/charts/violin-plot-complete-guide/}. 

**Age** seems have a no sigfnicant relationship with LeaguIndex. The variance at the highlest level seems to be much narrower then that at the lower levels. 

**HourPerWeek** 

**
```{r, echo=FALSE,compact=FALSE, error=FALSE}
...
p2<-ggplot(sc, aes(x=factor(LeagueIndex), y=HoursPerWeek)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
p3<-ggplot(sc, aes(x=factor(LeagueIndex), y=log(TotalHours))) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
...
###
p1<-ggplot(sc, aes(x=factor(LeagueIndex), AssignToHotkeys)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()

p2<-ggplot(sc, aes(x=factor(LeagueIndex), y=UniqueHotkeys)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()

p3<-ggplot(sc, aes(x=factor(LeagueIndex), y=log(MinimapAttacks))) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
p4<-ggplot(sc, aes(x=factor(LeagueIndex), y=log(MinimapRightClicks))) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
grid.arrange(p1,p2,p3,p4,ncol=2)
###
p1<-ggplot(sc, aes(x=factor(LeagueIndex), TotalMapExplored)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()

p2<-ggplot(sc, aes(x=factor(LeagueIndex), y=WorkersMade)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()

p3<-ggplot(sc, aes(x=factor(LeagueIndex), y=UniqueUnitsMade)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
p4<-ggplot(sc, aes(x=factor(LeagueIndex), y=ComplexUnitsMade)) +
  geom_violin(trim=FALSE, fill='#A4A4A4', color="blue") + stat_summary(fun.data=mean_sdl, mult=1, 
                 geom="pointrange", color="darkblue")+ coord_flip()
grid.arrange(p1,p2,p3,p4,ncol=2)
```
