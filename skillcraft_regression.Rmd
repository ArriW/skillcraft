...
git add --all
git commit -m "Recording the potential confounding variables."
git push
```
...
Upon closer examination of the remaining predictors its surprising that TotalHours and HoursPerWeek do not have a higher correlation. I did not expect both two make it to the final mode. 
...
The notable change in **ComplexAbilitiesUsed** is is likely a result the removal of the variable **ComplexUnitMade
