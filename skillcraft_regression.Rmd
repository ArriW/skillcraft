...
git add --all
git commit -m "Editting. Removing things that are overkill for midterm 2. Touching up the final"
git push
```
...
[Remove some redundant items here]
Before trimming an all the large modelthe following columns will be removed.
- Remove Action Latency
- Remove GapBetweenPACs - this is redundant but more importantly 
- Remove Number of PACS
- Remove SelectbyHotkeys
