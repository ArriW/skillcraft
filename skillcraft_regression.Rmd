...
Logistic regression predicts $p$,the probability a binomial response, alternatively ordinal regression predicts $p_i$ the predictors ceoffients partitioned by rank outcome $i \in LeagueIndex$. This encoding predicts the logit odds based on a set of parameters $X$. 
```{r, error=FALSE}
require(foreign)
require(ggplot2)
require(MASS)
