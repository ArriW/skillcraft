...
## Multivariant Regression Model Manual ModelIterations ($\Omega$ to $\omega$)
...
high that a confounding variable may have been removed. Revisiting correlation plot generated previousl

https://www.scribbr.com/methodology/confounding-variables/

Upon closer examination of the remaining predictors its surprising that TotalHours and HoursPerWeek do not have a higher correlation. Assign to hotkeys is a fairly highly correlated with APM that they warrant a further investigation.
...
Does this point stick across two different models?
