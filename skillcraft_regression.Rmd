...
The confidence Intervals Table^[Delta values are normalized by dividing by the mean of the model by related predictors confidence interval] show only a few subtleties between models coefficients confidence intervals. For comparison two summary statistics were added as follows:
...
The OMEGA model includes many 0 values. Amongst delta the most interesting difference notable difference 
```{r,echo=FALSE}
